...
class update_employee  implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employee set name='"+t1.getText()+"',father_name='"+t2.getText()+"',dob='"+t9.getText()+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email_id='"+t5.getText()+"',education='"+t6.getText()+"',job_post='"+t7.getText()+"',aadhar='"+t8.getText()+"' where emp_id='"+id_emp+"'";
