    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                ...
                JOptionPane.showMessageDialog(null,"errors occurred ! Duplicate entry");
