...
class print_data implements ActionListener{
    ...
    String emp_id,name,father,address,phone,email,education,jobpost,age,dob,aadhar;
    JButton b1,b2;
    ImageIcon icon;
